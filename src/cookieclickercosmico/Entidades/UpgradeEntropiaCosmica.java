...
public class UpgradeEntropiaCosmica extends Upgrade {
    ...
    public UpgradeEntropiaCosmica() {
        super(
            "Entropia Positiva", 
            "Aumenta a eficiência de todas as suas unidades em 10% através da manipulação térmica.", 
            10000.0, 
            1.10 // 1.10 representa um aumento de 10%
        );
    }
    ...
    public void aplicarEfeito(GameState estado) {
        ...
        System.out.println("Upgrade aplicado: Produção global aumentada em 10%!");
    }
}